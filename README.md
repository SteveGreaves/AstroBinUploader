...
This Python script is designed to enable astrophotographers to produce an acqusition.csv file suitible for upload to AstroBin.  
...
If python is not installed, instructions can be how to install it can be found here [Python Installation Instructions](https://python.land/installing-python).   
Once python is installed the required libraries can be installed from the command line by typing: 
...
### Run the script from the directory as follows 

        `python3 AstroBinUploadCSV.py directory_path1 directory_path2  directory_pathn hfr_set`.

There must be at least one directory path, but there can be as many as need to capture all the image files. The image files can be collected in one or more directories. The last argument is hfr_set, if it is empty hfr_set will be set equal to zero, if it is a floating point number hfr_set will be the number.
hfr_set is used if there is no value for HFR found in the image pathname. An example program call is given below:
...
The contents of Rosette Nebula (Caldwell 49) acquisition.csv are given below::
    ...
    |------------|--------|--------|----------|---------|------|---------------|-------|-------|-----------|------|--------|---------|----------|-------------|
    | 2022-01-12 | 4663   | 15     | 600      | 1       | 100  | -10           | 50    | 50    | 0         | 100  | 4      | 20.52   |          | 0.62        |
    | 2022-01-13 | 4663   | 34     | 600      | 1       | 100  | -10           | 50    | 50    | 0         | 100  | 4      | 20.52   |          | -0.26       |
    | 2022-01-13 | 4844   | 4      | 600      | 1       | 100  | -10           | 50    | 50    | 0         | 100  | 4      | 20.52   |          | -0.38       |
    | 2022-01-14 | 4663   | 14     | 600      | 1       | 100  | -10           | 50    | 50    | 0         | 100  | 4      | 20.52   |          | -1.04       |
    | 2022-01-14 | 4844   | 23     | 600      | 1       | 100  | -10           | 50    | 50    | 0         | 100  | 4      | 20.52   |          | -1.7        |
    | 2022-01-15 | 4844   | 4      | 600      | 1       | 100  | -10           | 50    | 50    | 0         | 100  | 4      | 20.52   |          | -2          |
    | 2022-01-18 | 4844   | 1      | 600      | 1       | 100  | -10           | 50    | 50    | 0         | 100  | 4      | 20.52   |          | -0.8        |
    | 2022-01-19 | 4844   | 2      | 600      | 1       | 100  | -10           | 50    | 50    | 0         | 100  | 4      | 20.52   |          | -0.55       |
    | 2022-01-20 | 4844   | 11     | 600      | 1       | 100  | -10           | 50    | 50    | 0         | 100  | 4      | 20.52   |          | -0.5        |
    | 2022-01-21 | 4844   | 17     | 600      | 1       | 100  | -10           | 50    | 50    | 0         | 100  | 4      | 20.52   |          | -0.72       |
    | 2022-01-22 | 4844   | 13     | 600      | 1       | 100  | -10           | 50    | 50    | 0         | 100  | 4      | 20.52   |          | -0.56       |
    | 2022-01-27 | 4752   | 22     | 600      | 1       | 100  | -10           | 50    | 50    | 0         | 100  | 4      | 20.52   |          | 1.78        |
    | 2022-01-28 | 4752   | 3      | 600      | 1       | 100  | -10           | 50    | 50    | 0         | 100  | 4      | 20.52   |          | 0.67        |
    | 2022-01-29 | 4752   | 20     | 600      | 1       | 100  | -10           | 50    | 50    | 0         | 100  | 4      | 20.52   |          | 3.74        |
    | 2022-01-30 | 4752   | 11     | 600      | 1       | 100  | -10           | 50    | 50    | 0         | 100  | 4      | 20.52   |          | 1.79        |

These can be copied and pasted into AstroBins import csv dialog
